<%-- 
    Document   : Vuelo
    Created on : May 16, 2017, 1:56:53 PM
    Author     : Pablo
--%>
    ...
    <body>
        ...
        <div class="modal fade" id="myModalFormulario" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title" id="myModalTitle">Consultando Vuelos</h4>
                    </div>
                    <div class="modal-body" id="myModalBody">
                        <div class="container-fluid table-responsive">
                            <table class="table table-hover table-condensed" id="tablaVuelosBusqueda"></table>
                        </div> 
                    </div>
                </div>
            </div>
        ...
        <div id="container">
            ...
            <div class="container">
                ...
                <h2 style="margin-left: 10%">Gestión de vuelos</h2>
                <br>
                <br>

                <form class="form-horizontal" id="formVuelos" onsubmit="enviar(); return false;">
                    <div class="form-group" id="groupIdVuelo">
                        <label class="control-label col-sm-2" for="idVuelo">Identificador de vuelo: </label>
                        <div class="col-sm-3">
                            <input  class="form-control" id="idVuelo" onkeypress="return validaNum(event)">
                        </div>
                    </div>
                    <div class="form-group" id="groupIdAvion">
                        <label class="control-label col-sm-2" for="idAvion">Digite el id del avion al que corresponde esta vuelo: </label>
                        <div class="col-sm-3">
                            <select  class="form-control" id="idAvion"></select>
                        </div>
                    </div>
                    <div class="form-group" id="groupIdRuta" >
                        <label class="control-label col-sm-2" for="idRuta">Digite el id de la ruta al que corresponde este vuelo: </label>
                        <div class="col-sm-3">
                            <select  class="form-control" id="idRuta"></select>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="cancelarR">
                        <input type="hidden" value="agregarVuelos" id="vuelosAction"/>
                        <button type="reset" class="btn btn-default" id="cancelar">Cancelar</button>
                        <button type="submit" class="btn btn-default" id="enviar">Agregar vuelo</button>
                    </div>
                    <br><br><br>
                    <hr>
                    <h3>Vuelos Existentes</h3>
                     <div class="form-group" id="groupCedula">
                                <div class="col-sm-4" style="text-align: right; vertical-align: middle;">
                                    <p><b>Buscar por id del Vuelo:</b></p>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="buscarId" placeholder="Digite id del vuelo">
                                </div>
                                <div class="col-sm-4">
                                    <button type="button" class="btn btn-info centered"    id="BuscarVuelo">
