<%-- 
    Document   : Flota
    Created on : 08/05/2017, 07:07:49 PM
    Author     : Mary
--%>
        ...
        <div class="modal fade" id="myModalFormulario" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title" id="myModalTitle">Consultando Aviones</h4>
                    </div>
                    <div class="modal-body" id="myModalBody">
                        <div class="container-fluid table-responsive">
                            <table class="table table-hover table-condensed" id="tablaAvionesBusqueda"></table>
                        </div> 
                    </div>
                </div>
            </div>
        ...
        <div id="container">
           ...
           <!-- ********************************************************** -->
            ...
            <div class="container">
                ...
                <h2 style="margin-left: 10%">Gestión de Aviones</h2>
                <br>
                <br>

                <form class="form-horizontal" id="formAviones" onsubmit="enviar(); return false;">
                    <div class="form-group" id="groupIdAvion">
                        <label class="control-label col-sm-2" for="idAvion">Identificador de avion: </label>
                        <div class="col-sm-3">
                            <input  class="form-control" id="idAvion" >
                        </div>
                    </div>
                    <div class="form-group" id="groupMarca">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control" id="Marca">
                                ...
                                <option value="Túpolev">Túpolev</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group" id="groupModelo" >
                        ...
                        <div class="col-sm-3">
                            <select class="form-control" id="Modelo">
                                ...
                                <option value="Túpolev Tu-204">Túpolev Tu-204</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="groupPasajeros">
                        <label class="control-label col-sm-2" for="pasajeros">Cantidad de Pasajeros: </label>
                        <div class="col-sm-3">
                             <input id="pasajeros" class="form-control" type="number" name="quantity" min="1" max="490">
                        </div>
                    </div>
                    <div class="form-group" id="groupFilas">
                        <label class="control-label col-sm-2" for="filas">Cantidad de filas: </label>
                        <div class="col-sm-3">
                             <input id="filas" class="form-control" type="number" name="quantity" min="1" max="70">
                        </div>
                    </div>
                    <div class="form-group" id="groupAxFilas">
                        <label class="control-label col-sm-2" for="axfilas">Asientos por fila: </label>
                        <div class="col-sm-3">
                             <input id="axfilas" class="form-control" type="number" name="quantity" min="1" max="7">
                        </div>
                    </div>
                    <br>
                    <div class="form-group" id="cancelarR">
                        <input type="hidden" value="agregarAviones" id="avionAction"/>  
                        <button type="reset" class="btn btn-default" id="cancelar">Cancelar</button>
                        <button type="submit" class="btn btn-default" id="enviar">Agregar avion</button>
                    </div>
                    <br><br><br>
                    <hr>
                    <h3>Aviones Existentes</h3>
                    <br>
                     <div class="form-group" id="groupCedula">
                                <div class="col-sm-4" style="text-align: right; vertical-align: middle;">
                                    <p><b>Buscar por marca del avion:</b></p>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="buscarMarca" placeholder="Digite la marca del avion">
                                </div>
                                <div class="col-sm-4">
                                    <button type="button" class="btn btn-info centered"    id="BuscarAvion">
                    ...
                    <hr>
                    <div class="container-fluid table-responsive">
                        <table class="table table-hover table-condensed" id="tablaAviones"></table>
                    </div> 
